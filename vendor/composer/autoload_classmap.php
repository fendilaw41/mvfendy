...
return array(
    ...
    'App\\FavoriteMovie' => $baseDir . '/app/FavoriteMovie.php',
    ...
    'Bacart\\Common\\Exception\\AbstractCommonException' => $vendorDir . '/bacart/common/src/Exception/AbstractCommonException.php',
    'Bacart\\Common\\Exception\\JsonException' => $vendorDir . '/bacart/common/src/Exception/JsonException.php',
    'Bacart\\Common\\Exception\\MissingPackageException' => $vendorDir . '/bacart/common/src/Exception/MissingPackageException.php',
    'Bacart\\Common\\Exception\\UnexpectedTypeException' => $vendorDir . '/bacart/common/src/Exception/UnexpectedTypeException.php',
    'Bacart\\Common\\Util\\ClassUtils' => $vendorDir . '/bacart/common/src/Util/ClassUtils.php',
    'Bacart\\Common\\Util\\JsonUtils' => $vendorDir . '/bacart/common/src/Util/JsonUtils.php',
    'Bacart\\Common\\Util\\StringUtils' => $vendorDir . '/bacart/common/src/Util/StringUtils.php',
    'Bacart\\GuzzleClient\\Client\\GuzzleClient' => $vendorDir . '/bacart/guzzle-client/src/Client/GuzzleClient.php',
    'Bacart\\GuzzleClient\\Client\\GuzzleClientInterface' => $vendorDir . '/bacart/guzzle-client/src/Client/GuzzleClientInterface.php',
    'Bacart\\GuzzleClient\\Exception\\GuzzleClientException' => $vendorDir . '/bacart/guzzle-client/src/Exception/GuzzleClientException.php',
    'Bacart\\GuzzleClient\\Formatter\\GuzzleMessageFormatter' => $vendorDir . '/bacart/guzzle-client/src/Formatter/GuzzleMessageFormatter.php',
    'Bacart\\GuzzleClient\\Middleware\\GuzzleClientMiddlewareInterface' => $vendorDir . '/bacart/guzzle-client/src/Middleware/GuzzleClientMiddlewareInterface.php',
    'Bacart\\GuzzleClient\\Middleware\\LogMiddleware' => $vendorDir . '/bacart/guzzle-client/src/Middleware/LogMiddleware.php',
    'Bacart\\GuzzleClient\\Middleware\\RequestRetryMiddleware' => $vendorDir . '/bacart/guzzle-client/src/Middleware/RequestRetryMiddleware.php',
    'Bacart\\GuzzleClient\\Middleware\\ResponseCacheMiddleware' => $vendorDir . '/bacart/guzzle-client/src/Middleware/ResponseCacheMiddleware.php',
    'Bacart\\GuzzleClient\\Middleware\\UserAgentMiddleware' => $vendorDir . '/bacart/guzzle-client/src/Middleware/UserAgentMiddleware.php',
