       ...
       <div class="container-fluid">
          <div class="row footer-standard">
             <div class="col-lg-6">
                ...
                <div class="widget text-left">
                   <div class="textwidget">
                      <p><small>© 2024 Fendi Movie. All Rights Reserved.</small></p>
                   </div>
                </div>
             </div>
             ...
             <div class="col-lg-3 col-md-6 mt-4 mt-lg-0">
                <div class="widget text-left">
                   <div class="textwidget">
                      <h6 class="footer-link-title">Fendi Movie</h6>
                      <div class="d-flex align-items-center">
                         <a class="app-image" href="#">
                            <img src="{{ asset('assets/images/footer/01.jpg') }}" alt="play-store" loading="lazy">
                         </a><br>
                         <a class="ml-3 app-image" href="#"><img src="{{ asset('assets/images/footer/02.jpg') }}"
